...
- **Crossing motion:** discrete breakpoint jumps (fold, rotation, split-screen snap) animate — the detail grows out of its pane (inline/overlay) or plays the route's real entrance (route mode); continuous window drags track the hand with a clean cut.
