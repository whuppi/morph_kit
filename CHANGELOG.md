...
- **Pane collapsing:** edge anchors with open clamps settle a pane to zero width (Material's pane-expansion edges, macOS's split-view collapse); `PaneConfig(collapseOnDoubleTap: true)` adds double-tap-to-collapse with proportional restore.
